"""Consensus timestamp rules for the GameCoin mainnet-candidate line."""
...
def median_time_past(blocks: Iterable[Dict[str, Any]], window: int = MEDIAN_TIME_WINDOW) -> int:
    """Return the median timestamp of the most recent blocks."""
...
def validate_block_timestamp(
    ...
    *,
    ...
    """Validate median-time-past and maximum-future-time rules."""
